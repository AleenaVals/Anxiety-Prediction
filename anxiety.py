...
# In[2]:
df=pd.read_csv('/home/aleen/Downloads/anxietyprediction.csv')
...
sns.heatmap(tip.corr(), cmap='Blues', annot=True, fmt='.2f',center=0)
...
sns.heatmap(demo.corr(), cmap='Spectral', annot=True, fmt='.2f', center=0)
